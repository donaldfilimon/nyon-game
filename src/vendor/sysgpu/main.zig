...
pub const Impl = sysgpu.Interface(struct {
    ...
    pub fn commandEncoderCopyTextureToTextureInternal(command_encoder: *sysgpu.CommandEncoder, source: *const sysgpu.ImageCopyTexture, destination: *const sysgpu.ImageCopyTexture, copy_size: *const sysgpu.Extent3D) void {
        _ = command_encoder;
        _ = source;
        _ = destination;
        _ = copy_size;
    ...
    pub fn querySetGetType(query_set: *sysgpu.QuerySet) sysgpu.QueryType {
        _ = query_set;
        @panic("unimplemented");
    }
    ...
    pub fn renderBundleEncoderFinish(render_bundle_encoder: *sysgpu.RenderBundleEncoder, descriptor: ?*const sysgpu.RenderBundle.Descriptor) *sysgpu.RenderBundle {
        _ = render_bundle_encoder;
        _ = descriptor;
        @panic("unimplemented");
    }
    ...
    pub fn sharedTextureMemoryCreateTexture(shared_texture_memory: *sysgpu.SharedTextureMemory, descriptor: *const sysgpu.Texture.Descriptor) *sysgpu.Texture {
        _ = shared_texture_memory;
        _ = descriptor;
        @panic("unimplemented");
    }
    ...
    pub fn swapChainConfigure(swap_chain: *sysgpu.SwapChain, format: sysgpu.Texture.Format, allowed_usage: sysgpu.Texture.UsageFlags, width: u32, height: u32) void {
        _ = swap_chain;
        _ = format;
        _ = allowed_usage;
        _ = width;
    ...
    pub fn swapChainGetCurrentTexture(swap_chain: *sysgpu.SwapChain) ?*sysgpu.Texture {
        _ = swap_chain;
        @panic("unimplemented");
    }
    ...
    pub fn textureGetDimension(texture: *sysgpu.Texture) sysgpu.Texture.Dimension {
        _ = texture;
        @panic("unimplemented");
    }

    pub fn textureGetFormat(texture: *sysgpu.Texture) sysgpu.Texture.Format {
        _ = texture;
        @panic("unimplemented");
    }
    ...
    pub fn textureGetUsage(texture: *sysgpu.Texture) sysgpu.Texture.UsageFlags {
        _ = texture;
        @panic("unimplemented");
    }
