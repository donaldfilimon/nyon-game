...
pub const World = struct {
    ...
    pub fn removeComponent(self: *World, entity_id: entity.EntityId, comptime T: type) !void {
        ...
        const new_comp_count = current_archetype.component_types.items.len - 1;
        var new_comp_types = std.ArrayList(archetype.ComponentType).initCapacity(self.allocator, new_comp_count) catch return error.OutOfMemory;
