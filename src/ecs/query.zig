...
//!
//! This module provides the query system for efficient iteration over entities
...
pub const Query = struct {
    ...
    /// Update the query with current archetypes from the world
    ...
    /// Entity data returned by the iterator
