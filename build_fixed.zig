...
pub fn build(b: *std.Build) void {
    ...
    const raylib_lib = raylib_zig_dep.artifact("raylib");
    ...
    setupBuildSteps(b, exe, editor_exe, nyon_game_mod, raylib_lib, null);
...
pub fn setupBuildSteps(
    ...
    const run_step = b.step("run", "Build and run game");
    ...
    const run_editor_step = b.step("run-editor", "Build and run editor");
